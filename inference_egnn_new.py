...
def train_predict():
    ...
    data_path = '/root/autodl-tmp/MLF-DTA/source/data/'
    ...
    # Measure time for this operation
    ...
    model = CSCoDTA(tau=args.tau,
                    ...
                    t_ms_dims=[54 + 33, 54 + 33, (54 + 33) * 2, 128],
                    # d_ms_dims=[178, 178, 178 * 2, 128],
                    # t_ms_dims=[87, 87, 87 * 2, 128],
                    embedding_dim=128,
                    dropout_rate=args.edge_dropout_rate)
    ...
    best_result = [1000]
    best_epoch = -1
    model_name = 'model_wo_Constrative'
    predictor_name = 'predictor_wo_Constrative'

    print("Start training...")

    start_time = time.time()
    trained_path = '/root/autodl-tmp/MLF-DTA/new_train/'
    ...
    for epoch in range(args.epochs):
        ...
        if r[0] < best_result[0]:
            ...
            torch.save(model.state_dict(), checkpoint_path, _use_new_zipfile_serialization=False)

            checkpoint_dir = trained_path + f"pre_trained models/{dataset}/"
            checkpoint_path = checkpoint_dir + predictor_name + ".pkl"
    ...
    G, P = test(model, predictor, device, test_loader, drug_graphs_DataLoader, target_graphs_DataLoader, affinity_graph,
                drug_pos, target_pos)
    result = model_evaluate(G, P, dataset=args.dataset)
    print("result:", result)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=2000)  # --kiba 3000
    ...
    parser.add_argument('--edge_dropout_rate', type=float, default=0.0)  # --kiba 0.
